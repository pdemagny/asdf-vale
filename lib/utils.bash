...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for vale.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for vale
...
install_version() {
	...
	(
		...
		# TODO: Assert vale executable exists.
		local tool_cmd
